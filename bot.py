...
WELCOME_TEXT = (
    ...
    "🌐 Хотите безопасный, быстрый и простой VPN? "
    "FastVPN автоматически выдаёт Outline VPN ключи сразу после оплаты!\n\n"
    "🔐 Защита данных и приватность\n"
    "⚡ Максимальная скорость без ограничений\n"
    "🤝 Реферальная программа — +7 дней бесплатно за каждого друга\n\n"
...
def main_menu_kb():
    ...
    kb.add(
        ...
        InlineKeyboardButton("🛠 Инструкция по подключению", callback_data="show_instruction"),
        InlineKeyboardButton("💳 Реквизиты для оплаты / Я оплатил(а)", callback_data="show_rekviz")
    )
    return kb
